...
nsclc.sparse.m <- Read10X_h5(filename = '/Users/ssiddique/Desktop/Bioinformatics_Learning/Single_cell_RNA_seq_data_Analysis/20k_NSCLC_DTC_3p_nextgem_donor_1_count_sample_feature_bc_matrix.h5')
str(nsclc.sparse.m)
...
# individual clusters
p1<-DimPlot(nsclc.seurat.obj, reduction = "umap")
# Generate UMAP plot
p1 <- DimPlot(nsclc.seurat.obj, reduction = "umap")

# Save the UMAP plot as a PNG file
ggsave(filename = "/Users/ssiddique/Desktop/Bioinformatics_Learning/Single_cell_RNA_seq_data_Analysis/Umap.png", 
       plot = p1, 
       width = 16, 
       height = 8, 
       units = "in")
